...
With that in mind, usually when a student comes to me, I do like to go through the final exam with them and make sure everything was graded fairly. Typically, I can usually find 1-2 points that I am able to give back[^1], so if a student is *really* on the cusp, this is a good way to get them past that cusp. 

# I've Heard it All

However, once we're talking half a percentage point or more, there's usually little I can do. I have heard the laundry list of arguments though[^2], so I want to quickly go over the most common ones:
